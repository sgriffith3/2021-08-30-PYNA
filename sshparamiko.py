...
def commandissue(command_to_issue, sshsession):
    ...
    #ssh_out = sshsession.exec_command(command_to_issue)
    #print(ssh_out)
    #input("Pausing")
    #print(ssh_out[0].read())
    #input("Pausing")
    #print(ssh_out[1].read())
    #input("Pausing")
    #print(ssh_out[2].read())
    #input("Pausing")
...
def main():
    ...
    ## creds to connect
    sshsession.connect(hostname="10.10.2.5", username="zoidberg", password="alta3")

    ## a simple list of commands to issue across our connection
    our_commands = ["touch sshworked.txt", "touch create.txt", "touch file3.txt", "ls -al"]
